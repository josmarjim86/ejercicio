...
CREATE TABLE `cuentabancaria` (
  ...
  `digito_control` int(11) DEFAULT NULL,
  `número_cuenta` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_cliente`),
  CONSTRAINT `FK_CUENTA_CLIENTE` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2016-02-04 13:43:31
